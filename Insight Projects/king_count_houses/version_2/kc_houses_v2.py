...
#---------------------
#Data Collect
data = readingDataFrame('../data/kc_house_data.csv')
...
saveDataFrameInCSV(data, '../data/kc_house_data_updated.csv')
...
print(dataBuy)
resetIndex(dataBuy)
saveDataFrameInCSV(dataBuy, '../data/properties_to_be_purchased.csv')
...
print(dataSale)
saveDataFrameInCSV(dataSale, '../data/gain_from_sale_of_properties.csv')
